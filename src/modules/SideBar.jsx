		...
		return (
			<div className="sidebar-bg">
				...
				<div className="view-button-container">
					<Button className={view_button}> <img src={todayicon} alt=""></img>&nbsp;&nbsp;Today</Button><br /><br />
					<Button className={view_button}> <img src={weeklyicon} alt=""></img>&nbsp;&nbsp;Weekly</Button><br /><br />
					<Button className={view_button}> <img src={monthlyicon} alt=""></img>&nbsp;&nbsp;Monthly</Button><br /><br />
					<Button className={view_button}> <img src={yearlyicon} alt=""></img>&nbsp;&nbsp;Yearly</Button><br /><br />
				</div>
